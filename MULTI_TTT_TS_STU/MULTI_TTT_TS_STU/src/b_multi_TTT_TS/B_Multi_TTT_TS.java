...
class AtomicBooleanEncapsulation {
	public AtomicBoolean ticPossible = new AtomicBoolean(/* COMPLETE */true);
	public AtomicBoolean tacPossible = new AtomicBoolean(/* COMPLETE */false);
	public AtomicBoolean toePossible = new AtomicBoolean(/* COMPLETE */false);
}
